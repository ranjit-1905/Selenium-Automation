...
public class TreeSetExample {
	...
	public void treeSetExample(){
		...
		//headSet()
		System.out.println("Values lesser than given value(headSet)"+treeSet.headSet(3));
		//tailSet()
		System.out.println("Values equal to and higher than given value  (tailSet)"+treeSet.tailSet(9));
		//subSet()
		...
		//normal iteration
		Iterator<Integer> iterator_list=treeSet.iterator();
		while (iterator_list.hasNext()) {
			System.out.println(iterator_list.next());
					
		}
		System.out.println("__________________________________________");
		Iterator<Integer> Descending_list=treeSet.descendingIterator();
		while (Descending_list.hasNext()) {
			System.out.println(Descending_list.next());
	}
		System.out.println("__________________________________________");
	}
